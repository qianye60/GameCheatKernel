...
namespace ImGui
{
    ...
    IMGUI_API bool          TabButton( const char* icon, const char* label, bool active );   // button
    IMGUI_API bool          Button(const char* label, const ImVec2& size = ImVec2(0, 0));   // button
    IMGUI_API bool          Button( const char* icon, const char* label, const ImVec2& size = ImVec2( 0, 0 ) );   // button
    IMGUI_API bool          SUBTAB(const char* name, bool boolean);
    IMGUI_API bool          TAB(const char* icon, const char* name, bool boolean, bool useCustomStyle = false);
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddCircleFilledMultiColor(const ImVec2& center, float radius, ImU32 col_center_upr, ImU32 col_center_bot, ImU32 col_upr_right, ImU32 col_bot_right, ImU32 col_bot_left, ImU32 col_upr_left, int num_segments);
    ...
    IMGUI_API void  AddHexa(const ImVec2& p1, const ImVec2& p2, const ImVec2& p3, const ImVec2& p4, const ImVec2& p5, const ImVec2& p6, ImU32 col, float thickness = 1.0f);
    IMGUI_API void  AddHexaFilled(const ImVec2& p1, const ImVec2& p2, const ImVec2& p3, const ImVec2& p4, const ImVec2& p5, const ImVec2& p6, ImU32 col);
